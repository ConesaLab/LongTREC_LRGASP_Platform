...
print('Start Launching Executed Task')
...
utilitiesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)), "utilities_ch1")
print('Utilites:', utilitiesPath)
        ...
        if not args.gtf:
            if os.path.exists(corrSAM):
                ...
                if args.aligner_choice == "gmap":
                    ...
                    print(os.getcwd())
                    print('args.sense:', args.sense, 'args.genome:', args.genome, 'args.isoforms:', args.isoforms)
...
def reference_parser(args, genome_chroms):
    ...
    print('Test for passed GTF TO GENEPRED')
...
def isoformClassification(args, isoforms_by_chr, refs_1exon_by_chr, refs_exons_by_chr, junctions_by_chr, junctions_by_gene, start_ends_by_gene, genome_dict, indelsJunc, orfDict):
    ...
    if args.polyA_peak is not None:
        ...
        print('args.polyA_peak:', args.polyA_peak)
...
def run(args):
    ...
    for i in range(1, loop + 1):
        if i == 1:
            ...
            outputClassPath, outputJuncPath = get_class_junc_filenames(args)
            outputClassPath1 = outputClassPath
            outputJuncPath1 = outputJuncPath
            outputClassPath2 = "NA"
            outputJuncPath2 = "NA"

        elif i == 2:
            os.chdir("../results_file2")
            args.isoforms = args.isoforms2
            args.platform = args.platform2
            args.library_preparation = args.library_preparation2
            args.data_category = args.data_category2
            args.cage_peak = args.cage_peak2
            args.polyA_peak = args.polyA_peak2
            args.polyA_motif_list = args.polyA_motif_list2
            args.dir = os.getcwd()
            outputClassPath, outputJuncPath = get_class_junc_filenames(args)
            outputClassPath2 = outputClassPath
        ...
        isoforms_info = isoformClassification(args, isoforms_by_chr, refs_1exon_by_chr, refs_exons_by_chr,
                                              junctions_by_chr, junctions_by_gene, start_ends_by_gene, genome_dict,
                                              indelsJunc, orfDict)
            ...
            if len(fl_samples) == 1:  # single sample from PacBio
                ...
                for iso in isoforms_info:
                    if iso in fl_count_dict:
                        ...
                        print("WARNING: {0} not found in FL count file. Assign count as 0.".format(iso),
                              file=sys.stderr)
    ...
    if not args.skip_report:
        ...
        if os.path.exists(rdata_out):
             ...
             rerun=True
        print(RSCRIPTPATH, utilitiesPath, RSCRIPT_REPORT)
        cmd = RSCRIPTPATH + " {d}/{f} {c} {j} {d} {o} {org} {t}your_tool {p} {l} {da} {sirv_list} {ercc_list} {sequin_list} {c2} {j2} {p2} {l2} {da2} {sirv_list2} {ercc_list2} {sequin_list2} {dataset2} {comp} {bambu} {FLAIR} {Lyric} {IsoTools} {Mandalorion} {Iso_IB} {FLAMES} {IsoQuant} {Spectra} {TALON_LAPA} {StringTie2}".format(d=utilitiesPath,
                                                                                                                                                                                               f=RSCRIPT_REPORT,
                                                                                                                                                                                               c=outputClassPath1,
                                                                                                                                                                                               j=outputJuncPath1,
                                                                                                                                                                                               o=rdata_out,
                                                                                                                                                                                               ...
                                                                                                                                                                                               t=args.tool,
                                                                                                                                                                                               p=args.platform,
                                                                                                                                                                                               l=args.library_preparation,
                                                                                                                                                                                               da=args.data_category,
                                                                                                                                                                                               sirv_list=args.sirv_list,
                                                                                                                                                                                               ercc_list=args.ercc_list,
                                                                                                                                                                                               sequin_list=args.sequin_list,
                                                                                                                                                                                               c2=outputClassPath2,
                                                                                                                                                                                               j2=outputJuncPath2,
                                                                                                                                                                                               p2=args.platform2,
                                                                                                                                                                                               l2=args.library_preparation2,
                                                                                                                                                                                               da2=args.data_category2,
                                                                                                                                                                                               sirv_list2=args.sirv_list2,
                                                                                                                                                                                               ercc_list2=args.ercc_list2,
                                                                                                                                                                                               sequin_list2=args.sequin_list2,
                                                                                                                                                                                               dataset2=args.dataset2,
                                                                                                                                                                                               comp=args.comparison,
                                                                                                                                                                                               bambu=args.comp_bambu,
                                                                                                                                                                                               FLAIR=args.comp_FLAIR,
                                                                                                                                                                                               Lyric=args.comp_Lyric,
                                                                                                                                                                                               IsoTools=args.comp_IsoTools,
                                                                                                                                                                                               Mandalorion=args.comp_Mandalorion,
                                                                                                                                                                                               Iso_IB=args.comp_Iso_IB,
                                                                                                                                                                                               FLAMES=args.comp_FLAMES,
                                                                                                                                                                                               IsoQuant=args.comp_IsoQuant,
                                                                                                                                                                                               Spectra=args.comp_Spectra,
                                                                                                                                                                                               TALON_LAPA=args.comp_TALON_LAPA,
                                                                                                                                                                                               StringTie2=args.comp_StringTie2)
...
def rename_isoform_seqids(input_fasta, force_id_ignore=False):
    ...
    """
    print('input_fasta which was args.isoforms: ', input_fasta)
    type = 'fasta'
...
def main():
    ...
    parser.add_argument('organism', help='(?) CREATE HELP TEXT')
    ...
    parser.add_argument('cage_peak')
    parser.add_argument('polyA_peak')
    parser.add_argument('polyA_motif_list')
    parser.add_argument('platform')
    parser.add_argument('library_preparation')
    parser.add_argument('tool')
    parser.add_argument('data_category')
    parser.add_argument('sirv_list')
    parser.add_argument('ercc_list')
    parser.add_argument('sequin_list')
    parser.add_argument('comparison')
    parser.add_argument('comp_bambu')
    parser.add_argument('comp_FLAIR')
    parser.add_argument('comp_Lyric')
    parser.add_argument('comp_IsoTools')
    parser.add_argument('comp_Mandalorion')
    parser.add_argument('comp_Iso_IB')
    parser.add_argument('comp_FLAMES')
    parser.add_argument('comp_IsoQuant')
    parser.add_argument('comp_Spectra')
    parser.add_argument('comp_TALON_LAPA')
    parser.add_argument('comp_StringTie2')
    parser.add_argument('isoforms2')
    parser.add_argument('annotation2')
    parser.add_argument('genome2')
    parser.add_argument('coverage2')
    parser.add_argument('coverage_dir2')
    parser.add_argument('cage_peak2')
    parser.add_argument('polyA_peak2')
    parser.add_argument('polyA_motif_list2')
    parser.add_argument('platform2')
    parser.add_argument('library_preparation2')
    parser.add_argument('data_category2')
    parser.add_argument('sirv_list2')
    parser.add_argument('ercc_list2')
    parser.add_argument('sequin_list2')
    parser.add_argument('--dataset2', help='\t\tUse when running SQANTI with 2 datasets', action='store_true')
    ...
    args.output = 'lrgasp_platform_challenge_1'
    ...
    if args.experiment_json is None:
        ...
        print(
            "WARNING: Experiment JSON wasn't provided. A fake one will be used (you can find it in utilities/experiment_dummy.json. This won't have an effect on the evaluation, but you will find the made-up attributes in your report titles.")
    ...
    if args.genome == 'LRGASP_DATA':
        if args.organism == 'mouse':
            ...
            args.genome = "../../LONGTrec_LRGASP_Platform/lrgasp_grch38_sirvs.fasta"
        else:
    ...
    args.isoforms = os.path.abspath(os.path.join("../../",args.isoforms))
    ...
    print('USED args.isoforms:', args.isoforms)

    if not args.gtf:
        print('No gtf file for isoforms')
        if args.aligner_choice == 'gmap':
        ...
        print('args.isoforms: ', args.isoforms)
    ...
    if args.annotation == 'LRGASP_DATA':
        if args.organism == 'mouse':
            ...
            args.annotation = "../../LONGTrec_LRGASP_Platform/lrgasp_gencode_v39_annotation_sirvs.human.gtf"
        else:
            print('ERROR: User should provide genome file when organism is set to custom...')
    else:
    ...
    if args.coverage == 'LRGASP_DATA':
        if args.organism == 'mouse':
            ...
            args.coverage = "../../LONGTrec_LRGASP_Platform/gold_std_human"
        else:
    ...
    print('INPUT args.cage_peak:', args.cage_peak)
    if args.cage_peak == 'LRGASP_DATA':
        if args.organism == 'mouse':
            print('There is no CAGE data available for mouse in synapse?')
            args.cage_peak = None
        elif args.organism == 'human':
            args.cage_peak = "../../LONGTrec_LRGASP_Platform/CAGE_WTC11.all_reps.bed"
        else:
            print('ERROR: Cage Peak File cannot be set to "LRGASP Data" when Organism is set to "Custom"')
            sys.exit()
    elif args.cage_peak == 'reference':
        print('Provide other possible datasets???')
        args.cage_peak = None
    else:
        args.cage_peak = os.path.abspath(os.path.join("../../", args.cage_peak))
    print('USED args.cage_peak:', args.cage_peak)

    print('INPUT args.polyA_peak:', args.polyA_peak)
    if args.polyA_peak == 'LRGASP_DATA':
        if args.organism == 'mouse':
            args.polyA_peak = "../../LONGTrec_LRGASP_Platform/QuantSeq_ES.all_reps.bed"
        elif args.organism == 'human':
            args.polyA_peak = "../../LONGTrec_LRGASP_Platform/QuantSeq_WTC11.all_reps.bed"
        else:
            print('ERROR: Cage Peak File cannot be set to "LRGASP Data" when Organism is set to "Custom"')
            sys.exit()
    elif args.polyA_peak == 'reference':
        print('Provide other possible datasets???')
        args.polyA_peak = None
    else:
        args.polyA_peak = os.path.abspath(os.path.join("../../", args.polyA_peak))
    print('USED args.polyA_peak:', args.polyA_peak)


    print('INPUT args.polyA_motif_list:', args.polyA_motif_list)
    if args.polyA_motif_list == 'LRGASP_DATA':
        args.polyA_motif_list = '../../LONGTrec_LRGASP_Platform/polyA.list.txt'
    elif args.polyA_motif_list == 'NA':
        args.polyA_motif_list = None
    else:
        args.polyA_motif_list = os.path.abspath(os.path.join("../../", args.polyA_motif_list))
    print('Used args.polyA_motif_list:', args.polyA_motif_list)

    # For the 2nd dataset
    print('INPUT args.genome2:', args.genome2)
    if args.genome2 == 'LRGASP_DATA':
        if args.organism == 'mouse':
            args.genome2 = "../../LONGTrec_LRGASP_Platform/lrgasp_grcm39_sirvs.fasta"
        elif args.organism == 'human':
            args.genome2 = "../../LONGTrec_LRGASP_Platform/lrgasp_grch38_sirvs.fasta"
        else:
            print('ERROR: User should provide genome file when organism is set to custom...')
    elif args.genome2 != 'NA':
        args.genome2 = os.path.abspath(os.path.join("../../", args.genome2))
        if not os.path.isfile(args.genome2):
            print("ERROR: genome fasta {0} doesn't exist. Abort!".format(args.genome2), file=sys.stderr)
            sys.exit()
    print('USED args.genome2:', args.genome2)

    print('INPUT args.isoforms2:', args.isoforms2)
    if args.isoforms2 != 'NA':
        args.isoforms2 = os.path.abspath(os.path.join("../../", args.isoforms2))
        if not os.path.isfile(args.isoforms2):
            print("ERROR: Input isoforms {0} doesn't exist. Abort!".format(args.isoforms2), file=sys.stderr)
            sys.exit()
    ...
    print('INPUT args.annotation2:', args.annotation2)
    if args.annotation2 == 'LRGASP_DATA':
        if args.organism == 'mouse':
            args.annotation2 = "../../LONGTrec_LRGASP_Platform/lrgasp_gencode_vM28_sirvs.mouse.gtf"
        elif args.organism == 'human':
            args.annotation2 = "../../LONGTrec_LRGASP_Platform/lrgasp_gencode_v39_annotation_sirvs.human.gtf"
        else:
            print('ERROR: User should provide genome file when organism is set to custom...')
    elif args.annotation2 != 'NA':
        print('is niet NA')
        args.annotation2 = os.path.abspath(os.path.join("../../", args.annotation2))
        if not os.path.isfile(args.annotation2):
            print("ERROR: Annotation {0} doesn't exist. Abort!".format(args.annotation2), file=sys.stderr)
            sys.exit()
    print('USED args.annotation2:', args.annotation2)

    print('INPUT args.coverage2:', args.coverage2)
    if args.coverage2 == 'LRGASP_DATA':
        if args.organism == 'mouse':
            args.coverage2 = "../../LONGTrec_LRGASP_Platform/gold_std_ES"
        elif args.organism == 'human':
            args.coverage2 = "../../LONGTrec_LRGASP_Platform/gold_std_human"
        else:
            print('ERROR: Coverage Directory cannot be set to "LRGASP Data" when Organism is set to "Custom"')
            sys.exit()
    elif args.coverage2 == 'NA':
        args.coverage2 = None
    else:
        args.coverage2 = os.path.abspath(os.path.join("../../uploads/coverage_files", args.coverage_dir))
    print('USED args.coverage:', args.coverage2)

    print('INPUT args.cage_peak2:', args.cage_peak2)
    if args.cage_peak2 == 'LRGASP_DATA':
        if args.organism == 'mouse':
            print('There is no CAGE data available for mouse in synapse?')
            args.cage_peak2 = None
        elif args.organism == 'human':
            args.cage_peak2 = "../../LONGTrec_LRGASP_Platform/CAGE_WTC11.all_reps.bed"
        else:
            print('ERROR: Cage Peak File cannot be set to "LRGASP Data" when Organism is set to "Custom"')
            sys.exit()
    elif args.cage_peak2 == 'reference':
        print('Provide other possible datasets???')
        args.cage_peak2 = None
    elif args.cage_peak != 'NA':
        args.cage_peak2 = os.path.abspath(os.path.join("../../", args.cage_peak2))
    print('USED args.cage_peak2:', args.cage_peak2)

    print('INPUT args.polyA_peak2:', args.polyA_peak2)
    if args.polyA_peak2 == 'LRGASP_DATA':
        if args.organism == 'mouse':
            args.polyA_peak2 = "../../LONGTrec_LRGASP_Platform/QuantSeq_ES.all_reps.bed"
        elif args.organism == 'human':
            args.polyA_peak2 = "../../LONGTrec_LRGASP_Platform/QuantSeq_WTC11.all_reps.bed"
        else:
            print('ERROR: Cage Peak File cannot be set to "LRGASP Data" when Organism is set to "Custom"')
            sys.exit()
    elif args.polyA_peak2 == 'reference':
        print('Provide other possible datasets???')
        args.polyA_peak2 = None
    elif args.polyA_peak2 != 'NA':
        args.polyA_peak2 = os.path.abspath(os.path.join("../../", args.polyA_peak2))
    print('USED args.polyA_peak2:', args.polyA_peak2)

    print('INPUT args.polyA_motif_list2:', args.polyA_motif_list2)
    if args.polyA_motif_list2 == 'LRGASP_DATA':
        args.polyA_motif_list2 = '../../LONGTrec_LRGASP_Platform/polyA.list.txt'
    elif args.polyA_motif_list2 == 'NA':
        args.polyA_motif_list2 = None
    else:
        args.polyA_motif_list2 = os.path.abspath(os.path.join("../../", args.polyA_motif_list2))
    print('Used args.polyA_motif_list2:', args.polyA_motif_list2)
